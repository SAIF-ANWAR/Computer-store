    ...
    return (
        <div style={{ backgroundColor: "#F5F5F7" }}>
            <div className="container">
                <div className="row row-cols-md-4 row-cols-sm-6 align-items-center p-4 gx-5">
                    <div className="col-md-3 col-sm-6"><p style={{ color: "#5BC8E7" }} className='fs-3 fw-bold'>Computer Store </p>
                        <small>  Location: Dhaka, Bangladesh <br />
                            Email: saifanwar5123@gmail.com <br />
                            Phone: 01777777777</small>
                    </div>
                    <div className="col-md-3 mt-3 col-sm-6"><p className='text-dark fw-bold  text-center'>About Computer Store </p>
                        <small>
                    ...
                    <div className="col-md-3 mt-3 col-sm-6"><p className='text-dark fw-bold text-center'>Customer Service </p>
                    ...
                    <div className="col-md-3 col-sm-6"><p className='text-dark fw-bold text-center'>Find us on </p>
